...
class muscatConversion extends frontControllerApplication
{
	...
	public function marcparser ()
	{
		...
		$form->heading ('p', "A subfield can be set as horizontally-repeatable by adding R, e.g. {$this->doubleDagger}b?R{//acq/ref} . Horizontal repeatability of a subfield takes precendence over vertical repeatability. A modifier, u, allows repeatability without a space between each token.");
