...
class muscatConversion extends frontControllerApplication
{
	...
	private $reports = array (
		...
		'tgmismatch_problem' => 'records whose *tg count does not match *t (not all will be errors)',
		...
		'sernonuniquet_problem' => '*ser records where t is not unique',
