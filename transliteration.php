...
class transliteration
{
	...
	*/
	...
	private function transliterationProtectedStrings ()
	{
		...
		$protectedStrings[] = '/' . '(?:^|\s|\()' . '([IVXLCDM]+[-IVXLCDM]*)' . '(?:$|\s|\)|,)' . '/';		// Word boundary used to avoid e.g. "Vladimir" being treated as non-translitered 'V' + transliterated 'ladimir', e.g. /records/85867/ (test #1006); standalone letter without "." after (e.g. as in "M.L." in author) not treated as Roman numeral, e.g. /records/4578/ (test #1009)
