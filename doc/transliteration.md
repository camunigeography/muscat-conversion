...
* `protectSubstrings` is currently wrapped by `extractFromParallelTitle` in the two places it is currently used. This needs to be brought inside `protectSubstrings`.
